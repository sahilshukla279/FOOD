    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Donate</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">Food</a></li>

              <li><a href="#" class="list-group-item disabled">Clothes</a></li>
              <li><a href="#" class="list-group-item disabled">Utensils</a></li>
              <li><a href="#" class="list-group-item disabled">Other Items</a></li>
            </ul>
          </li>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Email:</strong> f.o.o.d.@gmail.com<br>
            </p>
          </div>
