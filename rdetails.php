...
$dbname = "food";
    ...
    $sql = "UPDATE `reg_tb` SET `First Name`='$fname',`Last Name`='$lname',`Address 1`='$address1',`Address 2`='$address2',`Town`='$town',`City`='$city',`State`='$state',`Pincode`='$pincode',`Email`='$email',`Phone Number`='$phone' WHERE `Rid`= '$upid'";
    ...
    if ($conn->query($sql) === TRUE) 
    {
        ...
        echo 'window.location.href = "rdetails.php";';
        echo '</script>';
  ...
  $sql = "DELETE FROM `reg_tb` WHERE `Rid`= '$dlid'";
...
<body>
  ...
  <main id="main">
    ...
    ?>
            ...
            <tr>
              <th scope="row"><?php echo $rows['Rid']; ?></th>
...
function myupdate(data) {
      ...
      req.open("GET","rupdate.php?idvalue="+data,true);
      req.send();
